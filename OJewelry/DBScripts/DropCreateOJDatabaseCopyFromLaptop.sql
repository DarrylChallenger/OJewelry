...
/****** Object:  Database [OJewelryDB]    Script Date: 12/27/2017 5:58:22 PM ******/
/*
Manually create DB in each environment, the run script to build tables
*/

/*
DROP DATABASE [OJewelryDB]
GO
...
GO
ALTER DATABASE [OJewelryDB] SET  DISABLE_BROKER WITH ROLLBACK IMMEDIATE
GO
