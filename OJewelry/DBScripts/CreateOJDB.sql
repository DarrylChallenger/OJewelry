...
CREATE DATABASE [OJewelryDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'OJewelryDB', FILENAME = N'C:\Users\Darryl\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\OJewelryDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'OJewelryDB_log', FILENAME = N'C:\Users\Darryl\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB\OJewelryDB.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
*/
